      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/get-quote"
              className="w-full sm:w-auto px-8 py-4 rounded-full bg-primary text-primary-foreground font-semibold hover:bg-primary/80 transition-colors duration-300 shadow-[0_0_20px_rgba(0,229,255,0.3)] flex items-center justify-center gap-2 text-lg"
            >
