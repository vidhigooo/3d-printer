      ...
      <div className="container mx-auto px-6">
        ...
        <div className="pt-8 border-t border-border/50 flex flex-col items-center justify-center gap-4 text-slate-700 dark:text-slate-300">
          <div className="flex items-center gap-5">
            ...
            {/* Facebook */}
            <a href="https://www.facebook.com/vektor3ds" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-1 transition-transform">
            ...
            {/* LinkedIn */}
            <a href="https://www.linkedin.com/company/vektor3dsystems/" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-1 transition-transform">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/channel/UCkKkKfIyaWiT2WDXXc80GnQ" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-1 transition-transform">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/vektor3ds_" target="_blank" rel="noopener noreferrer" className="hover:-translate-y-1 transition-transform">
