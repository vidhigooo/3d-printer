...
export default function DIY3DPrinters() {
    ...
    <div className="relative min-h-screen overflow-hidden pt-36 pb-24 selection:bg-primary/30">
      ...
      <div className="container relative mx-auto px-6">
        ...
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          >
            Discover our extensive range of high-quality DIY 3D printers. Perfect for hobbyists, engineers, and creators.
          </motion.p>
        </div>

        {/* Product Grid */}
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {diyProducts.map((product, idx) => (
            <motion.div
              key={product.id}
            ...
            >
              ...
              <div 
                ...
                onClick={() => router.push(`/3d-printers/diy-3d-printers/${product.slug}`)}
              >
                ...
                <button
                  onClick={() => {
                    if (!product.outOfStock) {
                       router.push(`/3d-printers/diy-3d-printers/${product.slug}`);
                    }
                  }}
