      ...
      <div className="container relative mx-auto px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          >
            ...
            {/* Main Active Image */}
            <div className="glass relative flex flex-1 aspect-[4/3] md:aspect-auto md:min-h-[500px] w-full items-center justify-center overflow-hidden rounded-[32px] border border-white/10 bg-gradient-to-b from-white/5 to-transparent shadow-2xl">
              <div className="absolute inset-0 bg-black/20" />
              <div className="relative z-10 h-full w-full p-8">
                <Image src={images[activeImage]} alt={product.name} fill className="object-contain drop-shadow-2xl p-8" />
              </div>
            </div>
          </motion.div>
            ...
            <div className="mb-10 space-y-8 rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-md">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {overviewPoints.slice(0, 7).map((point, i) => (
