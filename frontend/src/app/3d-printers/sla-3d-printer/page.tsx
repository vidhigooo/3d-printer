          ...
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-3">
              {printerLineup.map((printer) => (
                <article
                  key={printer.name}
                  className="group overflow-hidden rounded-[28px] border border-border bg-white/[0.04] shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:border-sky-500/30 hover:shadow-[0_0_40px_-10px_rgba(14,165,233,0.22)]"
                >
                  ...
                  <div className="space-y-5 p-7">
                    ...
                    <Link
                      href="/get-quote"
                      className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-slate-100 dark:bg-slate-900/50 px-5 py-3 text-sm font-bold text-foreground transition-all hover:border-sky-500/30 hover:bg-sky-500/10 hover:text-sky-200"
                    >
                      Get Quote
            ...
            <div className="mt-16 overflow-hidden rounded-[28px] border border-border bg-white/[0.04] shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-2">
                {specs.map(([label, value], index) => (
                  <div
                    key={label}
                    className={`flex items-center justify-between gap-4 border-b border-border px-6 py-5 ${index % 2 === 0 ? "md:border-r" : ""} ${index === specs.length - 1 ? "border-b-0" : ""}`}
                  >
