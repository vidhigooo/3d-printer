        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {deliverables.map((item, i) => (
              <div key={i} className={`group relative p-8 rounded-3xl bg-slate-900/60 backdrop-blur-xl border border-white/5 overflow-hidden transition-all duration-500 hover:-translate-y-2 flex flex-col items-center text-center ${item.glow}`}>
                <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                
                <div className={`w-20 h-20 mb-8 rounded-2xl bg-slate-950 flex items-center justify-center border border-white/10 shadow-lg relative overflow-hidden group-hover:border-white/20 transition-colors duration-300`}>
      ...
      <section className="relative py-24 z-10 border-y border-white/5 bg-slate-900/20">
        <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 relative w-full aspect-[4/3] rounded-[24px] overflow-hidden group">
            ...
            />
            <div className="absolute bottom-6 left-6 z-20 w-14 h-14 rounded-2xl bg-slate-900/80 backdrop-blur-md border border-white/10 flex items-center justify-center shadow-[0_0_20px_rgba(0,0,0,0.5)]">
            ...
            <ul className="space-y-4">
              {applications.map((app, idx) => (
                <li key={idx} className="flex items-center gap-4 group">
                  ...
                  <span className="text-lg font-medium text-slate-200 group-hover:text-white transition-colors">{app}</span>
                </li>
              ))}
            </ul>
          </div>
      ...
      <section className="relative py-32 z-10 overflow-hidden">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-center gap-12 md:gap-4">
            ...
            <div className="hidden md:block absolute top-12 left-24 right-24 h-[2px] bg-slate-800 z-0">
            ...
            <div className="md:hidden absolute top-0 bottom-0 left-1/2 w-[2px] bg-slate-800 z-0 -translate-x-1/2">
            ...
            {processSteps.map((step) => {
              ...
              return (
                <div key={step.id} className="relative z-10 flex flex-col items-center text-center gap-6 group w-full md:w-1/3">
                  <div className="relative flex items-center justify-center w-24 h-24 rounded-2xl bg-slate-900 border border-slate-700 group-hover:border-cyan-500/50 group-hover:shadow-[0_0_25px_rgba(0,229,255,0.2)] transition-all duration-300 backdrop-blur-md">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-200 mb-3 group-hover:text-white transition-colors">{step.title}</h3>
