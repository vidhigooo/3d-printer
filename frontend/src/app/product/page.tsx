...
export default function ProductCategories() {
  const categories = [
    {
      name: "3D Printing Resin",
      image: "/resin/1.png",
      description: "Premium resins for precise and detailed 3D printing.",
      href: "/product/3d-printing-resin",
    },
    {
      ...
      <div className="container relative mx-auto px-6">
        ...
        <div className="mx-auto mb-20 max-w-3xl text-center">
          ...
          >
            ...
            <span className="text-sm font-semibold uppercase tracking-widest text-primary">Materials Fleet</span>
          </motion.div>
