...
export default function VelvetCoatingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative selection:bg-cyan-500/30">
            ...
            <div className="relative z-10 w-full h-full rounded-[20px] bg-card/85 border border-border/50 overflow-hidden shadow-inner p-4 md:p-6 flex flex-col">
              ...
              <div className="mt-4 flex items-center justify-between gap-4 px-1">
                <div>
                  ...
                  <p className="mt-2 text-lg md:text-xl font-semibold text-foreground">Soft-Touch Velvet</p>
                </div>
      ...
      {/* Key Benefits */}
      <section className="relative py-24 z-10 bg-card/20 border-b border-border/50">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Key Benefits</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-purple-400 rounded-full mx-auto" />
            <p className="text-lg text-slate-700 dark:text-slate-300 max-w-2xl mx-auto pt-4">
      ...
      <section className="relative py-24 z-10 border-b border-border/50">
        <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 order-2 lg:order-1">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight mb-6">Ideal Applications</h2>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {applications.map((item) => (
                <li key={item} className="flex items-start gap-3 text-slate-700 dark:text-slate-300 text-sm font-medium p-4 rounded-xl bg-white/[0.02] border border-border/50 hover:bg-white/[0.05] transition-colors group">
          ...
          <div className="relative aspect-square lg:aspect-[4/3] rounded-[24px] bg-card/50 backdrop-blur-xl border border-border shadow-[0_0_30px_rgba(6,182,212,0.1)] flex items-center justify-center p-2 group hover:border-cyan-500/40 transition-all duration-700 hover:-translate-y-2 overflow-hidden order-1 lg:order-2">
            ...
            <div className="w-full h-full rounded-[20px] bg-card/80 border border-border/50 relative overflow-hidden shadow-inner flex items-center justify-center p-6">
              <Image
                src="/velvet/2.png"
      ...
      {/* Showcase Gallery */}
      <section className="relative py-24 z-10 bg-card/20 border-b border-border/50 overflow-hidden">
        <div className="container mx-auto px-6 mb-16">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight mb-4">Our Showcase</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-purple-400 rounded-full mx-auto" />
          </div>
        </div>
        ...
        <div className="relative overflow-hidden [mask-image:linear-gradient(to_right,transparent,black_8%,black_92%,transparent)] w-full">
          <div className="velvet-track flex w-max gap-6 px-3">
            {[...showcaseImages, ...showcaseImages].map((src, index) => (
              <div key={index} className="group relative w-72 md:w-80 h-72 md:h-80 shrink-0 overflow-hidden rounded-[24px] border border-border bg-white/[0.02] hover:bg-white/[0.04] hover:border-cyan-500/30 transition-all duration-500 flex items-center justify-center p-6 shadow-xl">
                <Image
                  src={src}
      ...
      <section className="relative py-24 z-10 border-b border-border/50">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight mb-4">Workflow</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-purple-400 rounded-full mx-auto" />
          </div>
