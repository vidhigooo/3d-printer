...
const finishOptions = [
  { title: "Gold Plating", desc: "Premium decorative finish" },
...
export default function ElectroplatingPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-hidden relative selection:bg-amber-500/30">
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[-10%] h-[600px] w-[600px] rounded-full bg-amber-600/10 blur-[150px]" />
        <div className="absolute bottom-[-10%] right-[-10%] h-[600px] w-[600px] rounded-full bg-slate-300/10 blur-[150px]" />
      ...
      <section className="relative pt-36 pb-20 md:pt-48 md:pb-28 px-6 z-10 border-b border-white/5">
        <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-300 text-sm font-semibold tracking-wide uppercase shadow-[0_0_15px_rgba(245,158,11,0.1)]">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              >
                <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#f59e0b_0%,#e5e7eb_50%,#f59e0b_100%)]" />
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 px-8 py-1 text-base font-bold text-white backdrop-blur-3xl transition-all group-hover:bg-slate-900 shadow-[0_0_25px_rgba(245,158,11,0.2)]">
          ...
          <div className="relative w-full aspect-square lg:aspect-[4/3] rounded-[24px] bg-black/40 backdrop-blur-xl border border-amber-500/20 shadow-[0_0_50px_rgba(245,158,11,0.12)] flex items-center justify-center p-3 group hover:border-amber-400/50 transition-colors duration-500 mt-10 lg:mt-0 overflow-hidden">
            <div className="absolute inset-0 bg-amber-500/20 blur-[80px] rounded-full scale-75 group-hover:bg-amber-400/30 transition-all duration-700" />
            <div className="relative z-10 w-full h-full rounded-[20px] bg-slate-900/85 border border-white/5 overflow-hidden shadow-inner p-4 md:p-6 flex flex-col">
              <div className="flex-1 min-h-0 rounded-[18px] overflow-hidden bg-slate-950/70 border border-white/10 flex items-center justify-center">
                <img
                  ...
                  alt="Electroplated gold and chrome finish"
              ...
              <div className="mt-4 flex items-center justify-between gap-4 px-1">
                <div>
                  <p className="text-xs uppercase tracking-[0.3em] text-amber-100/80">High-end close-up</p>
                  <p className="mt-2 text-lg md:text-xl font-semibold text-white">Gold / Chrome reflective surface</p>
                </div>
      ...
      <section className="relative py-20 z-10 bg-slate-900/20 border-b border-white/5">
        <div className="container mx-auto px-6 max-w-4xl text-center space-y-5">
          ...
          <div className="w-16 h-1 bg-gradient-to-r from-amber-500 to-slate-300 rounded-full mx-auto" />
        ...
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {finishOptions.map((item) => (
              <div key={item.title} className="p-8 rounded-3xl bg-slate-900/50 border border-white/5 hover:border-amber-500/30 transition-all duration-500 hover:-translate-y-2 shadow-xl">
        ...
        <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div>
              ...
              <div className="w-16 h-1 bg-gradient-to-r from-amber-500 to-slate-300 rounded-full" />
            </div>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {applications.map((item) => (
                <li key={item} className="flex items-center gap-3 text-slate-300 text-base font-medium p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group">
                  <CheckCircle2 className="w-5 h-5 text-amber-400 shrink-0 group-hover:scale-110 transition-transform" />
          ...
          <div className="relative aspect-square lg:aspect-[4/3] rounded-[24px] bg-slate-900/50 backdrop-blur-xl border border-white/10 shadow-[0_0_30px_rgba(245,158,11,0.1)] flex items-center justify-center p-2 group hover:border-amber-500/40 transition-all duration-700 hover:-translate-y-2 overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/10 to-slate-300/10 blur-[50px] rounded-full scale-75 group-hover:scale-100 transition-all duration-700 opacity-60" />
      ...
      <section className="relative py-24 z-10 border-b border-white/5">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4 relative max-w-6xl mx-auto">
            <div className="hidden md:block absolute top-8 left-[10%] w-[80%] h-[2px] bg-gradient-to-r from-transparent via-amber-500/50 to-transparent" />

            {processSteps.map((step, index) => (
              <div key={step} className="relative z-10 flex flex-col items-center gap-4 w-full md:w-auto group">
                <div className="w-16 h-16 rounded-full bg-slate-900 border border-white/10 flex items-center justify-center text-xl font-bold text-amber-400 shadow-[0_0_20px_rgba(245,158,11,0.05)] group-hover:border-amber-500/50 group-hover:shadow-[0_0_20px_rgba(245,158,11,0.3)] group-hover:-translate-y-1 transition-all duration-300">
                  {index + 1}
                </div>
                <span className="font-bold text-slate-300 text-center whitespace-nowrap group-hover:text-amber-300 transition-colors">{step}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="relative py-28 z-10 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent to-amber-900/20" />
        <div className="container mx-auto max-w-4xl px-6 text-center relative z-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/contact-us" className="relative inline-flex h-14 overflow-hidden rounded-xl p-[1px] focus:outline-none group">
              <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#f59e0b_0%,#e5e7eb_50%,#f59e0b_100%)]" />
              <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 px-10 py-1 text-lg font-bold text-white backdrop-blur-3xl transition-all group-hover:bg-slate-900 shadow-[0_0_25px_rgba(245,158,11,0.2)]">
                Request Custom Quote
              </span>
            </Link>
