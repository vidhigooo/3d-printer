    ...
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative selection:bg-cyan-500/30">
        ...
        <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground drop-shadow-[0_0_15px_rgba(255,255,255,0.18)]">
                ELECTROPLATING
              </h1>
              <p className="text-2xl md:text-3xl font-semibold text-slate-700 dark:text-slate-300 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              >
                ...
                <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-background px-8 py-1 text-base font-bold text-foreground backdrop-blur-3xl transition-all group-hover:bg-card shadow-[0_0_25px_rgba(6,182,212,0.2)]">
              ...
              <Link
                href="/get-quote"
                className="inline-flex h-14 items-center justify-center gap-2 rounded-xl border border-border bg-slate-100 dark:bg-slate-900/50 px-8 py-1 text-base font-bold text-foreground transition-all hover:bg-slate-100 dark:bg-slate-900 hover:border-border/80"
              >
          ...
          <div className="relative w-full aspect-square lg:aspect-[4/3] rounded-[24px] bg-black/40 backdrop-blur-xl border border-cyan-500/20 shadow-[0_0_50px_rgba(6,182,212,0.12)] flex items-center justify-center p-3 group hover:border-cyan-400/50 transition-colors duration-500 mt-10 lg:mt-0 overflow-hidden">
            ...
            <div className="relative z-10 w-full h-full rounded-[20px] bg-card/85 border border-border/50 overflow-hidden shadow-inner p-4 md:p-6 flex flex-col">
              <div className="flex-1 min-h-0 rounded-[18px] overflow-hidden bg-background/70 border border-border flex items-center justify-center">
                <img
              ...
              <div className="mt-4 flex items-center justify-between gap-4 px-1">
                <div>
                  ...
                  <p className="mt-2 text-lg md:text-xl font-semibold text-foreground">Blue chrome reflective surface</p>
                </div>
                <div className="rounded-full border border-white/15 bg-slate-100 dark:bg-slate-900/50 px-4 py-2 text-xs font-semibold text-foreground backdrop-blur-md whitespace-nowrap">
                  Dark premium look
                </div>
              </div>
            </div>
      ...
      <section className="relative py-20 z-10 bg-card/20 border-b border-border/50">
        <div className="container mx-auto px-6 max-w-4xl text-center space-y-5">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Short Intro</h2>
          <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-blue-400 rounded-full mx-auto" />
          <p className="text-xl md:text-2xl text-slate-700 dark:text-slate-300 leading-relaxed font-medium pt-4">
            We provide precision electroplating services that enhance the aesthetics, durability, and surface quality of your creations.
          </p>
        </div>
      </section>
      ...
      <section className="relative py-24 z-10 border-b border-border/50">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight">Finish Options</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-blue-400 rounded-full mx-auto" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {finishOptions.map((item) => (
              <div key={item.title} className="p-8 rounded-3xl bg-card/50 border border-border/50 hover:border-cyan-500/30 transition-all duration-500 hover:-translate-y-2 shadow-xl">
      ...
      <section className="relative py-24 z-10 bg-card/20 border-y border-border/50">
        <div className="container mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground tracking-tight mb-6">Applications</h2>
            ...
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {applications.map((item) => (
                <li key={item} className="flex items-center gap-3 text-slate-700 dark:text-slate-300 text-base font-medium p-4 rounded-xl bg-white/[0.02] border border-border/50 hover:bg-white/[0.05] transition-colors group">
          ...
          <div className="relative aspect-square lg:aspect-[4/3] rounded-[24px] bg-card/50 backdrop-blur-xl border border-border shadow-[0_0_30px_rgba(6,182,212,0.1)] flex items-center justify-center p-2 group hover:border-cyan-500/40 transition-all duration-700 hover:-translate-y-2 overflow-hidden">
            ...
            <div className="w-full h-full rounded-[20px] bg-card/80 border border-border/50 relative overflow-hidden shadow-inner">
              <img
              ...
              <div className="absolute inset-x-5 bottom-5 flex items-center justify-between gap-4">
                <span className="text-xs uppercase tracking-[0.3em] text-foreground/80">Reflective finish showcase</span>
                <span className="rounded-full border border-white/15 bg-slate-100 dark:bg-slate-900/50 px-3 py-1 text-xs font-semibold text-foreground backdrop-blur-md">Metallic detailing</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-24 z-10 border-b border-border/50">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground tracking-tight mb-4">Process</h2>
            <div className="w-16 h-1 bg-gradient-to-r from-cyan-500 to-blue-400 rounded-full mx-auto" />
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4 relative max-w-6xl mx-auto">
            ...
            {processSteps.map((step, index) => (
              <div key={step} className="relative z-10 flex flex-col items-center gap-4 w-full md:w-auto group">
                <div className="w-16 h-16 rounded-full bg-card border border-border flex items-center justify-center text-xl font-bold text-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.05)] group-hover:border-cyan-500/50 group-hover:shadow-[0_0_20px_rgba(6,182,212,0.3)] group-hover:-translate-y-1 transition-all duration-300">
                  {index + 1}
                </div>
      ...
      <section className="relative py-28 z-10 overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl px-6 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-black text-foreground mb-6 tracking-tight drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
            Discuss Your Surface Finishing Project
          </h2>
          <p className="text-lg md:text-xl text-slate-700 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto mb-10">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/get-quote" className="relative inline-flex h-14 overflow-hidden rounded-xl p-[1px] focus:outline-none group">
              <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#06b6d4_0%,#60a5fa_50%,#06b6d4_100%)]" />
              <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-background px-10 py-1 text-lg font-bold text-foreground backdrop-blur-3xl transition-all group-hover:bg-card shadow-[0_0_25px_rgba(6,182,212,0.2)]">
                Request Custom Quote
              </span>
            </Link>
            <Link href="/contact-us" className="inline-flex h-14 items-center justify-center rounded-xl border border-white/20 bg-slate-100 dark:bg-slate-900/50 px-10 py-1 text-lg font-bold text-foreground transition-all hover:bg-slate-100 dark:bg-slate-900 hover:border-white/30 hover:shadow-[0_0_20px_rgba(255,255,255,0.1)]">
              Discuss Your Surface Finishing Project
            </Link>
          </div>
        </div>
