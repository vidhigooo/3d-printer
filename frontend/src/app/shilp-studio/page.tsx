...
export default function ShilpStudioPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 overflow-hidden relative selection:bg-purple-500/30">
      ...
      <section className="relative pt-36 pb-20 md:pt-44 md:pb-28 px-6 z-10 border-b border-white/5">
        <div className="container mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Hero Visual Collage */}
          <div className="relative w-full aspect-[4/3] lg:aspect-square max-h-[600px] rounded-3xl bg-slate-900/50 backdrop-blur-xl border border-white/10 shadow-[0_0_60px_rgba(168,85,247,0.15)] flex items-center justify-center p-4 group hover:border-purple-500/40 transition-all duration-700 hover:-translate-y-2">
            ...
            <div className="w-full h-full relative z-10 rounded-[20px] bg-slate-800/80 border border-white/5 overflow-hidden shadow-inner">
      ...
      <section className="relative py-24 z-10 border-b border-white/5 bg-white/[0.01]">
        <div className="container mx-auto max-w-4xl px-6 text-center space-y-6">
          ...
          <p className="text-xl text-slate-400 leading-relaxed pt-4">
        ...
        <div className="container mx-auto max-w-7xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-3xl bg-slate-900/50 border border-white/5 flex flex-col items-center text-center gap-5 hover:-translate-y-2 transition-transform duration-500 hover:border-purple-500/30 group shadow-xl">
      ...
      <section className="relative py-24 z-10 border-b border-white/5 bg-white/[0.01]">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  <li key={i} className="flex items-center gap-3 text-slate-300 text-base font-medium p-4 rounded-xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-colors group">
            ...
            <div className="relative aspect-square lg:aspect-[4/3] rounded-3xl bg-slate-900/50 backdrop-blur-xl border border-white/10 shadow-[0_0_30px_rgba(168,85,247,0.1)] flex items-center justify-center p-2 group hover:border-purple-500/40 transition-all duration-700 hover:-translate-y-2">
              ...
              <div className="w-full h-full rounded-[20px] bg-slate-800/80 border border-white/5 relative overflow-hidden shadow-inner">
      ...
      <section className="relative py-24 z-10 border-b border-white/5">
        <div className="container mx-auto max-w-7xl px-6">
          <div className="text-center mb-16 space-y-4">
            ...
            <div className="w-16 h-1 bg-gradient-to-r from-orange-500 to-purple-500 rounded-full mx-auto" />
            <p className="text-slate-400 max-w-2xl mx-auto pt-4 text-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              ...
              <div key={i} className="flex flex-col items-center text-center gap-3 p-6 rounded-2xl bg-white/[0.03] border border-white/5 hover:border-purple-500/30 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="aspect-[3/4] rounded-2xl bg-slate-900 border border-white/5 overflow-hidden relative group shadow-lg">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-4 relative max-w-5xl mx-auto">
            ...
            {[
              ...
              <div key={i} className="relative z-10 flex flex-col items-center gap-4 w-full md:w-auto group">
                <div className="w-16 h-16 rounded-full bg-slate-900 border border-white/10 flex items-center justify-center text-xl font-bold text-purple-400 shadow-[0_0_20px_rgba(168,85,247,0.05)] group-hover:border-purple-500/50 group-hover:shadow-[0_0_20px_rgba(168,85,247,0.3)] group-hover:-translate-y-1 transition-all duration-300">
                  {i + 1}
                </div>
                <span className="font-bold text-slate-300 text-center whitespace-nowrap group-hover:text-purple-300 transition-colors">{step}</span>
              </div>
            ))}
          </div>
        </div>
