...
export default function AboutUsPage() {
  return (
    <div className="min-h-screen overflow-hidden bg-slate-950 text-slate-200 selection:bg-cyan-500/30">
      ...
      <main className="relative z-10 pt-36 pb-24 px-6 md:pt-44">
        <div className="container mx-auto max-w-5xl text-center mb-20">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.18)] md:text-5xl lg:text-6xl mb-8">
            Welcome to Vektor3D Systems LLP
          </h1>
          <p className="text-lg leading-relaxed text-slate-300 md:text-xl mb-6 max-w-4xl mx-auto">
            A trusted provider of advanced 3D printing, additive manufacturing, and digital production solutions.
          </p>
          <div className="space-y-6 text-base md:text-lg text-slate-400 max-w-4xl mx-auto text-left leading-relaxed">
            <p>
        ...
        <div className="container mx-auto max-w-6xl mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="rounded-[24px] border border-white/10 bg-slate-900/60 p-8 shadow-xl transition-all duration-500 hover:border-cyan-500/30 hover:bg-slate-900 hover:shadow-[0_0_40px_-10px_rgba(0,229,255,0.2)]">
            ...
            <div className="rounded-[24px] border border-white/10 bg-slate-900/60 p-8 shadow-xl transition-all duration-500 hover:border-purple-500/30 hover:bg-slate-900 hover:shadow-[0_0_40px_-10px_rgba(168,85,247,0.2)]">
        ...
        <div className="container mx-auto max-w-6xl mb-24 border-t border-white/5 pt-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-extrabold tracking-tight text-white md:text-4xl">What We Offer</h2>
            <div className="mt-4 mx-auto w-24 h-1 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full"></div>
          </div>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {whatWeOffer.map((item, index) => (
              <div key={index} className="flex flex-col items-center text-center p-6 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] transition-colors group">
                <div className="mb-4 text-cyan-400 group-hover:scale-110 group-hover:text-cyan-300 transition-transform">
                  <item.icon className="h-10 w-10" />
                </div>
                <h4 className="text-lg font-semibold text-slate-200 group-hover:text-white transition-colors">{item.title}</h4>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl mb-24 border-t border-white/5 pt-24">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-extrabold tracking-tight text-white md:text-4xl">Why Choose Vektor3D Systems LLP?</h2>
            <div className="mt-4 mx-auto w-24 h-1 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full"></div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {whyChooseUs.map((item, index) => (
              <div key={index} className="flex flex-col items-center text-center p-6 rounded-2xl bg-gradient-to-b from-white/[0.05] to-transparent border border-white/5 hover:border-white/20 transition-all group">
                <div className="mb-4 p-4 rounded-full bg-slate-900 border border-white/10 text-slate-300 group-hover:text-cyan-400 group-hover:border-cyan-500/30 transition-colors shadow-lg">
                  <item.icon className="h-6 w-6" />
                </div>
                <h4 className="text-sm md:text-base font-semibold text-slate-200">{item.title}</h4>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-cyan-500/10 via-white/[0.04] to-purple-500/10 px-8 py-16 shadow-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-white md:text-3xl leading-snug">
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact-us"
                className="inline-flex h-14 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-purple-500 px-8 text-base font-bold text-white shadow-[0_0_25px_rgba(0,229,255,0.2)] transition-all hover:scale-[1.02]"
              >
                Connect With Us
